    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.nav_notes:
                ...
                Intent intent = new Intent(Navigation.this, DownloadNotes.class);
                Bundle bundle = new Bundle();

                bundle.putString(DownloadNotes.EXTRA_BRANCH,   SaveSharedPreference.getBranch(Navigation.this));
