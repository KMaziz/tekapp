...
public class User {
    ...
    public User(String rollNo, String email, String name, String branch, String year) {
        this.rollno = rollNo;
        this.email = email;
        this.name = name;
        this.branch = branch;
    ...
    public static boolean addUser(String username, String email, String name, String branch, String year) {
        User user = new User(username, email, name, branch, year);
